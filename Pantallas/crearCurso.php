                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="mt-2">
                                    ...
                                    <input type="categoria" class="inputText mb-2" id="categoriaInput" name="categoriaNombre" placeholder="Ingrese la categoría">
                                    <textarea class="inputText inputTextarea mb-2" id="descripcionCategoria" name="categoriaDesc" rows="2" wrap="hard" placeholder="Ingrese una descripción de presentacion" maxlength="150" pattern="[A-Za-z0-9]{3,150}" title="Letras y números. Tamaño mínimo: 3. Tamaño máximo: 150"></textarea>
                                </div>
                                <div class="text-right">
                                    <a class="btn btn-secondary" id="NewCateg">+</a>
                                </div>
                                <div class="text-right mt-5">
                                    <button type="submit" id="btnAgregarCategorias" class="btn btn-primary" onclick="prevenirDefault(this.form);" disabled>Guardar categorias</button>
                                </div>
                            </div>
                        </div>
                    </div>
