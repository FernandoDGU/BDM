                                ...
                                <div class="col-8">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="categoria" 
                                               ...
                                               >
                                        <textarea class="inputText inputTextarea mb-2" 
                                    ...
                                    <div class="text-right mt-5">
                                        <button type="submit" id="btnAgregarCategorias" class="btn btn-primary" onclick="prevenirDefault(this.form);">Guardar categorias</button>
                                    </div>  
                                </div>
                            </div>
                        </div>
