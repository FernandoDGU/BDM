            ...
            $(document).ready(function () {
                ...
                $('#btnRegistro').click(function () {
                    if (checarValidacion(this.form)) {
                        ...
                        frData.append("optradio", $('input:radio[name=optradio]:checked').val());
                    ...
                    <div class="form-box">
                        ...
                        <form class="needs-validation" id="formRegistro" novalidate method="POST" action='' enctype="multipart/form-data">
                            ...
                            <div class="form-groupRadio">
                                <p> Usuario: </p>
                                <label class="radio-inline"><input type="radio" id = "optionradioP" name="optradio" value="Profesor" checked>Profesor</label>
                                <label class="radio-inline"><input type="radio" id = "optionradioA" name="optradio" value="Alumno">Alumno</label>
                            </div>
